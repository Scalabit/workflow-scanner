...
import (
	...
	"workflow-scanner/internal/querybuilder"
	"workflow-scanner/internal/telemetry"
)
...
// The `GithubIssueCommentID` scalar type represents an identifier for an object of type GithubIssueComment.
type GithubIssueCommentID string

// The `GithubIssueDataID` scalar type represents an identifier for an object of type GithubIssueData.
type GithubIssueDataID string

// The `GithubIssueID` scalar type represents an identifier for an object of type GithubIssue.
type GithubIssueID string

// The `GithubIssueTemplateID` scalar type represents an identifier for an object of type GithubIssueTemplate.
type GithubIssueTemplateID string
...
func (r *Binding) AsGithubIssue() *GithubIssue {
...
func (r *Binding) AsGithubIssueComment() *GithubIssueComment {
...
func (r *Binding) AsGithubIssueData() *GithubIssueData {
...
func (r *Binding) AsGithubIssueTemplate() *GithubIssueTemplate {
...
func (r *Env) WithGithubIssueCommentInput(name string, value *GithubIssueComment, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithGithubIssueCommentOutput(name string, description string) *Env {
...
func (r *Env) WithGithubIssueDataInput(name string, value *GithubIssueData, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithGithubIssueDataOutput(name string, description string) *Env {
...
func (r *Env) WithGithubIssueInput(name string, value *GithubIssue, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithGithubIssueOutput(name string, description string) *Env {
...
func (r *Env) WithGithubIssueTemplateInput(name string, value *GithubIssueTemplate, description string) *Env {
	assertNotNil("value", value)
...
func (r *Env) WithGithubIssueTemplateOutput(name string, description string) *Env {
...
type GithubIssue struct { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L19)
	query *querybuilder.Selection
...
type GithubIssueCreatePullRequestOpts struct {
	...
	//
	Branch string // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L346)
	//
	// base branch for pull request
	//
	//
	// Default: "main"
	Base string // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L349)
}

// Create a Github Pull Request
func (r *GithubIssue) CreatePullRequest(repo string, title string, body string, source *Directory, opts ...GithubIssueCreatePullRequestOpts) *GithubIssueData { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L334)
	assertNotNil("source", source)
...
func (r *GithubIssue) GetPrForCommit(ctx context.Context, repo string, commit string) (int, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L297)
...
func (r *GithubIssue) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadGithubIssueFromID(GithubIssueID(id))
	return nil
}
...
type GithubIssueListOpts struct {
	...
	//
	// Default: 1
	Page int // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L55)
}

// List Github issues for a repository
func (r *GithubIssue) List(ctx context.Context, repo string, opts ...GithubIssueListOpts) ([]GithubIssueData, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L49)
	...
	convert := func(fields []list) []GithubIssueData {
		...
		for i := range fields {
			...
			val.query = q.Root().Select("loadGithubIssueDataFromID").Arg("id", fields[i].Id)
			out = append(out, val)
		}
...
func (r *GithubIssue) ListComments(ctx context.Context, repo string, issueId int) ([]GithubIssueComment, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L145)
	...
	convert := func(fields []listComments) []GithubIssueComment {
		...
		for i := range fields {
			...
			val.query = q.Root().Select("loadGithubIssueCommentFromID").Arg("id", fields[i].Id)
			out = append(out, val)
		}
...
func (r *GithubIssue) ListCommentsUnified(ctx context.Context, repo string, issueId int) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L181)
...
type GithubIssueListUnifiedOpts struct {
	...
	//
	// Default: 1
	Page int // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L98)
}

// List Github issues for a repository and return a readable output for llms
func (r *GithubIssue) ListUnified(ctx context.Context, repo string, opts ...GithubIssueListUnifiedOpts) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L92)
...
func (r *GithubIssue) Read(repo string, issueId int) *GithubIssueData { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L114)
...
func (r *GithubIssue) Templates(ctx context.Context, repo string) ([]GithubIssueTemplate, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L503)
	...
	convert := func(fields []templates) []GithubIssueTemplate {
		...
		for i := range fields {
			...
			val.query = q.Root().Select("loadGithubIssueTemplateFromID").Arg("id", fields[i].Id)
			out = append(out, val)
		}
...
func (r *GithubIssue) TemplatesUnified(ctx context.Context, repo string) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L543)
...
func (r *GithubIssue) Write(repo string, title string, body string) *GithubIssueData { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L125)
...
func (r *GithubIssue) WriteComment(ctx context.Context, repo string, issueId int, body string) error { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L205)
...
func (r *GithubIssue) WritePullRequestCodeComment(ctx context.Context, repo string, issueId int, commit string, body string, path string, side string, line int) error { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L248)
...
type GithubIssueComment struct { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L138)
	query *querybuilder.Selection
...
func (r *GithubIssueComment) Author(ctx context.Context) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L139)
	if r.author != nil {
		return *r.author, nil
	}
...
func (r *GithubIssueComment) Body(ctx context.Context) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L140)
	if r.body != nil {
		return *r.body, nil
	}
...
func (r *GithubIssueComment) CreatedAt(ctx context.Context) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L141)
	if r.createdAt != nil {
...
func (r *GithubIssueComment) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadGithubIssueCommentFromID(GithubIssueCommentID(id))
	return nil
}

type GithubIssueData struct { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L34)
	query *querybuilder.Selection
...
func (r *GithubIssueData) BaseRef(ctx context.Context) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L43)
	if r.baseRef != nil {
...
// Issue body content
func (r *GithubIssueData) Body(ctx context.Context) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L39)
	if r.body != nil {
		return *r.body, nil
	}
	q := r.query.Select("body")
...
func (r *GithubIssueData) HeadRef(ctx context.Context) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L41)
	if r.headRef != nil {
...
func (r *GithubIssueData) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadGithubIssueDataFromID(GithubIssueDataID(id))
	return nil
}

func (r *GithubIssueData) IssueNumber(ctx context.Context) (int, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L35)
...
// Issue title
func (r *GithubIssueData) Title(ctx context.Context) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L37)
	if r.title != nil {
		return *r.title, nil
	}
...
func (r *GithubIssueData) URL(ctx context.Context) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L45)
	if r.url != nil {
		return *r.url, nil
	}
	q := r.query.Select("url")
...
type GithubIssueTemplate struct { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L497)
	query *querybuilder.Selection
...
func (r *GithubIssueTemplate) Content(ctx context.Context) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L499)
	if r.content != nil {
...
func (r *GithubIssueTemplate) UnmarshalJSON(bs []byte) error {
	...
	*r = *dag.LoadGithubIssueTemplateFromID(GithubIssueTemplateID(id))
	return nil
}

func (r *GithubIssueTemplate) Name(ctx context.Context) (string, error) { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L498)
	if r.name != nil {
		return *r.name, nil
	}
	q := r.query.Select("name")
...
// GithubIssueOpts contains options for Client.GithubIssue
type GithubIssueOpts struct {
	//
	// Github authentication token
	//
	Token *Secret // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L29)
}

// Crate a new GithubIssue object
func (r *Client) GithubIssue(opts ...GithubIssueOpts) *GithubIssue { // github-issue (https://github.com/kpenfound/dag/tree/b316e472d3de5bb0e54fe3991be68dc85e33ef38/github-issue/main.go#L26)
...
// Load a GithubIssueComment from its ID.
func (r *Client) LoadGithubIssueCommentFromID(id GithubIssueCommentID) *GithubIssueComment {
	q := r.query.Select("loadGithubIssueCommentFromID")
	q = q.Arg("id", id)
...
// Load a GithubIssueData from its ID.
func (r *Client) LoadGithubIssueDataFromID(id GithubIssueDataID) *GithubIssueData {
	q := r.query.Select("loadGithubIssueDataFromID")
	q = q.Arg("id", id)
...
// Load a GithubIssue from its ID.
func (r *Client) LoadGithubIssueFromID(id GithubIssueID) *GithubIssue {
	q := r.query.Select("loadGithubIssueFromID")
	q = q.Arg("id", id)
...
// Load a GithubIssueTemplate from its ID.
func (r *Client) LoadGithubIssueTemplateFromID(id GithubIssueTemplateID) *GithubIssueTemplate {
	q := r.query.Select("loadGithubIssueTemplateFromID")
	q = q.Arg("id", id)
...
func (r *Client) Workspace(source *Directory) *Workspace { // workspace (../../workspace/main.go:14:1)
	assertNotNil("source", source)
	q := r.query.Select("workspace")
	q = q.Arg("source", source)
...
type Workspace struct { // workspace (../../workspace/main.go:10:6)
	query *querybuilder.Selection
...
func (r *Workspace) ListFiles(ctx context.Context) (string, error) { // workspace (../../workspace/main.go:41:1)
	if r.listFiles != nil {
		return *r.listFiles, nil
	}
	q := r.query.Select("listFiles")
...
func (r *Workspace) ReadFile(ctx context.Context, path string) (string, error) { // workspace (../../workspace/main.go:21:1)
	if r.readFile != nil {
...
func (r *Workspace) Source() *Directory { // workspace (../../workspace/main.go:11:2)
	q := r.query.Select("source")
...
func (r *Workspace) WriteFile(path string, contents string) *Workspace { // workspace (../../workspace/main.go:29:1)
	q := r.query.Select("writeFile")
	q = q.Arg("path", path)
	q = q.Arg("contents", contents)

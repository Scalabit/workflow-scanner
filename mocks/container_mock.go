...
//
//	mockgen -source=container.go -destination=../../mocks/container_mock.go -package=mocks Container
//
...
func (m *MockContainer) WithDirectory(path string, source *dagger.Directory, opts ...dagger.ContainerWithDirectoryOpts) dagger0.Container {
	m.ctrl.T.Helper()

...
- `OPENAI_MODEL` - Default: `gpt-5-mini` ([available models](https://platform.openai.com/docs/models))
  ...
  security-scan:
    ...
    steps:
      ...
      - name: Scan and fix workflows
        ...
        env:
          OPENAI_MODEL: gpt-4o-mini  # Optional: specify a model (default: gpt-5-mini)
        with:
